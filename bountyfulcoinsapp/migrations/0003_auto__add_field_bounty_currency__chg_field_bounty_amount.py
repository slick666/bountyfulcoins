...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bounty.currency'
        db.add_column(u'bountyfulcoinsapp_bounty', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='BTC', max_length=3),
                      keep_default=False)


        # Changing field 'Bounty.amount'
        db.alter_column(u'bountyfulcoinsapp_bounty', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'Bounty.currency'
        db.delete_column(u'bountyfulcoinsapp_bounty', 'currency')


        # Changing field 'Bounty.amount'
        db.alter_column(u'bountyfulcoinsapp_bounty', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))
    ...
    models = {
        ...
        u'bountyfulcoinsapp.bounty': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "'BTC'", 'max_length': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
