...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bounty.amount'
        db.add_column(u'bountyfulcoinsapp_bounty', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bounty.amount'
        db.delete_column(u'bountyfulcoinsapp_bounty', 'amount')
    ...
    models = {
        ...
        u'bountyfulcoinsapp.bounty': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '20', 'decimal_places': '8'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
