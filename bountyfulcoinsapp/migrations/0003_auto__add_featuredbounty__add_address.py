...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'bountyfulcoinsapp', ['FeaturedBounty'])

        # Adding model 'Address'
        db.create_table(u'bountyfulcoinsapp_address', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('address_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
            ('verified_balance', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=6)),
            ('last_synced', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'bountyfulcoinsapp', ['Address'])


    def backwards(self, orm):
        # Deleting model 'FeaturedBounty'
        db.delete_table(u'bountyfulcoinsapp_featuredbounty')

        # Deleting model 'Address'
        db.delete_table(u'bountyfulcoinsapp_address')
